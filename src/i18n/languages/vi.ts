export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt Weo',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên Weo',
  ...
  'commands.plugin.description': 'Quản lý plugin Weo',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động Weo',
  'commands.status.description':
    'Hiển thị trạng thái Weo bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của Weo',
  'commands.stickers.description': 'Đặt mua sticker Weo',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án Weo',
