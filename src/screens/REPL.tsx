...
export function REPL({
  ...
  const terminalTitle = sessionTitle ?? agentTitle ?? haikuTitle ?? 'Weo';
  ...
  useEffect(() => {
    const handleSuspend = () => {
      ...
      process.stdout.write(`\nOpenClaude has been suspended. Run \`fg\` to bring Weo back.\nNote: ctrl + z now suspends Weo, ctrl + _ undoes input.\n`);
    };
    const handleResume = () => {
